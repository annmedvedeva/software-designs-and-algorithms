...
/**
 * Either is represents a value of one of two possible types (a disjoint union).https://en.wikipedia.org/wiki/Disjoint_union
 * An instance of Either is either an instance of Left or Right
 * A common use of Either is as error handler or as alternative to Maybe when there are a some payload empty value
 */
...
export const map = <E, A, B>(fn: (a: A) => B) => (fa: Either<E, A>): Either<E, B> => (
    isLeft(fa) ? fa : right(fn(fa.right))
)
